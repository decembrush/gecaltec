<?php
	$pageTitle = 'Dictamenes | Administrador';
	include("header.php");
?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form-nDictamen">
        	<div class="form-ch">
			  <div class="form-group row">
				<div class="col-md-6">
					<label for="nDic_iden">Identificador</label>
					<input id="nDic_iden" name="nDic_iden" type="text" class="form-control" required>
				</div>
				<div class="col-md-6">
					<label for="nDic_cod">Codigo</label>
			  ...
			  <div class="form-group">
				...
				<p class="help-block">Adjunte archivos .PDF, .JPG, ó .PNG.</p>
			  </div>
